...
function createAttractors(num){
	...
	function createUpdate(object, i){
		var ra = 200 * Math.random(), sp = (Math.random()-.5)*7, offset = Math.random()*100, raxis = new THREE.Vector3(Math.random(),Math.random(),Math.random());
		var rot = 0;
