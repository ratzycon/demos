...
function start() {
    ...
    //window.location = "http://culturewar.online";
    
    //window.location = "https://threejs.org/examples/webgl_loader_mmd.html";
    //window.location ="http://core.exposed/";
    window.location ="http://core.exposed/webgl/starmap.html";
}
